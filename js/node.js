class Node {
   ...
   draw() {
      ...
      if (this.wall) {
         crc.fillStyle = grey
         crc.fillRect(offsetX+this.pos.x*scale, offsetY+this.pos.y*scale,
                      scale, scale)

         crc.strokeStyle = lightGrey
         crc.strokeRect(offsetX+this.pos.x*scale, offsetY+this.pos.y*scale, scale, scale)
         return;
      }
      ...
      crc.fillStyle = col
      crc.fillRect(offsetX+(this.pos.x +0.5 -size*0.5)*scale, offsetY+(this.pos.y +0.5 -size*0.5)*scale,
