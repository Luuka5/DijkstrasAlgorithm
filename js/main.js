...
const green = "#86c232", darkGreen = "#61892f", black = "#222629", grey = "#474b4f", lightGrey = "#6b6e70";
...
function draw() {
   ...
   crc.fillStyle = "#fff"
   crc.fillRect(offsetX+start.x*scale, offsetY+start.y*scale,
                scale, scale)
   crc.fillRect(offsetX+goal.x*scale, offsetY+goal.y*scale,
                scale, scale)
}
...
function mouse(e) {
   ...
   try {
      map[(e.offsetX-offsetX)/scale | 0][(e.offsetY-offsetY) /scale | 0].setWall(!e.ctrlKey)
   } catch (e) {}
}
